    ...
    <div class="card-body">
        <form action="" id="po-form">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label text-info">P.O. كود</label>
                        <input type="text" class="form-control form-control-sm rounded-0" value="<?php echo isset($po_code) ? $po_code : '' ?>" readonly>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="supplier_id" class="control-label text-info">الموردون</label>
                ...
                <hr>
                <fieldset>
                    <legend class="text-info">نموذج السلعة</legend>
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="item_id" class="control-label">غرض</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="unit" class="control-label">وحدة</label>
                        ...
                        <div class="col-md-2 text-center">
                            <div class="form-group">
                                <button type="button" class="btn btn-flat btn-sm btn-primary" id="add_to_list">القائمة</button>
                            </div>
                        </div>
                </fieldset>
                <hr>
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <thead>
                        <tr class="text-light bg-navy">
                            ...
                            <th class="text-center py-1 px-2">غرض</th>
                            <th class="text-center py-1 px-2">يكلف</th>
                            <th class="text-center py-1 px-2">المجموع</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                    ...
                    <tfoot>
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">المجموع الفرعي</th>
                            <th class="text-right py-1 px-2 sub-total">0</th>
                        </tr>
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">نخفيض <input style="width:40px !important" name="discount_perc" class='' type="number" min="0" max="100" value="<?php echo isset($discount_perc) ? $discount_perc : 0 ?>">%
                        ...
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">ضريبة <input style="width:40px !important" name="tax_perc" class='' type="number" min="0" max="100" value="<?php echo isset($tax_perc) ? $tax_perc : 0 ?>">%
                        ...
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">المجموع
