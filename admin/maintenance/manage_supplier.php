...
<div class="container-fluid">
	<form action="" id="supplier-form">
		...
		<div class="form-group">
			<label for="cperson" class="control-label">الشخص الذي يمكن الاتصال به</label>
			<input name="cperson" id="cperson" class="form-control rounded-0" value="<?php echo isset($cperson) ? $cperson : ''; ?>">
		</div>
		<div class="form-group">
			<label for="contact" class="control-label">اتصال#</label>
		...
		<div class="form-group">
			...
			<option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>نشيط</option>
			<option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>غير نشيط</option>
			</select>
		</div>
	</form>
</div>
