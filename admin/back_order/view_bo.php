...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">تفاصيل الطلب الخلفي - <?php echo $bo_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label text-info">من P.O. كود</label>
                ...
                <div class="col-md-6">
                    <label class="control-label text-info">B.O. كود</label>
                    <div><?php echo isset($bo_code) ? $bo_code : '' ?></div>
                </div>
            </div>
            <h4 class="text-info">الاوردرات</h4>
            <table class="table table-striped table-bordered" id="list">
                ...
                <thead>
                    <tr class="text-light bg-navy">
                        ...
                        <th class="text-center py-1 px-2">وحدة</th>
                ...
                <tfoot>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">المجموع الفرعي</th>
                        <th class="text-right py-1 px-2 sub-total"><?php echo number_format($total,2)  ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">تخفيض <?php echo isset($discount_perc) ? $discount_perc : 0 ?>%</th>
                        <th class="text-right py-1 px-2 discount"><?php echo isset($discount) ? number_format($discount,2) : 0 ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">ضريبة <?php echo isset($tax_perc) ? $tax_perc : 0 ?>%</th>
                        <th class="text-right py-1 px-2 tax"><?php echo isset($tax) ? number_format($tax,2) : 0 ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">المجموع</th>
            ...
            <div class="row">
                ...
                <?php if($status > 0): ?>
                <div class="col-md-6">
                    <span class="text-info"><?php echo ($status == 2)? "تلقى" : "PARTIALLY RECEIVED" ?></span>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=back_order' ?>">الرجوع للخلف</a>
    </div>
</div>
