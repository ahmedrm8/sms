                ...
                <fieldset>
                    ...
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-2 text-center">
                            <div class="form-group">
                                <button type="button" class="btn btn-flat btn-sm btn-primary" id="add_to_list">انشاء جديد</button>
                            </div>
                        </div>
                </fieldset>
                <hr>
...
<script>
    ...
    $(function(){
        $('.select2').select2({
            placeholder:"الرجاء التحديد هنا",
            width:'resolve',
        })
        $('#item_id').select2({
            placeholder:"الرجاء تحديد المورد أولا",
            width:'resolve',
        })
        ...
        $('#supplier_id').change(function(){
            ...
            if(!!items[supplier_id]){
                ...
                list_item.then(function(){
                    $('#item_id').select2({
                        placeholder:"الرجاء تحديد العنصر هنا",
                        width:'resolve',
                    })
                })
            }else{
                list_item.then(function(){
                    $('#item_id').select2({
                        placeholder:"لا توجد عناصر مدرجة حتى الآن",
                        width:'resolve',
                    })
                })
            }
