...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">تسجيلات المبيعات - <?php echo $sales_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label text-info">كود المبيعات</label>
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-success" type="button" id="print">مطبعة</button>
        <a class="btn btn-flat btn-primary" href="<?php echo base_url.'/admin?page=sales/manage_sale&id='.(isset($id) ? $id : '') ?>">يحرر</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=sales' ?>">الرجوع للقائمة</a>
    </div>
</div>
