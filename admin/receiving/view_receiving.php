...
<div class="card card-outline card-primary">
    ...
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                ...
                <?php if(isset($bo_id)): ?>
                <div class="col-md-6">
                    <label class="control-label text-info">من B.O. كود</label>
                    <div><?php echo isset($bo_code) ? $bo_code : '' ?></div>
                </div>    
                <?php endif; ?>
            </div>
            <h4 class="text-info">طلبات</h4>
            <table class="table table-striped table-bordered" id="list">
                ...
                <thead>
                    <tr class="text-light bg-navy">
                        ...
                        <th class="text-center py-1 px-2">وجدة</th>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary" href="<?php echo base_url.'/admin?page=receiving/manage_receiving&id='.(isset($id) ? $id : '') ?>">تعديل</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=receiving' ?>">العودة للخلف</a>
    </div>
</div>
